declare module 'canvas' {
  ...
  export class Canvas {
    ...
    toDataURL (mimeType: 'image/jpeg', callback: (err: Error | null, jpeg: string) => void): void
    toDataURL (mimeType: 'image/jpeg', options: JPEGConfig | number, callback: (err, jpeg) => void): void
